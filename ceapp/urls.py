...
urlpatterns = [
    ...
    path('admin-panel/ssa/add-member/<int:pk>', AdminPanelAddMemberToSSAAPIView.as_view(), name='add-member-ssa'),
    path('admin-panel/ssa/delete-member/<int:ssa>/<int:member>/', AdminPanelDeleteMemberFromSSAAPIView.as_view(),
         name='delete-member-ssa'),
    path('admin-panel/ssa/edit-member/<int:ssa>/<int:member>/', AdminPanelEditMemberSSAAPIView.as_view(),
         name='edit-member-ssa'),
